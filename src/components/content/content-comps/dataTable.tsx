...
import { DataTableComps } from "@/components/content/content-comps/dataTableComps/data-table-comps";
import {
  Payment,
  columns,
} from "@/components/content/content-comps/dataTableComps/columns";
async function fetchData() {
  const data = [
    ...
    },
    {
      id: 5,
      company: "Basecamp",
      logo: "https://assets.stickpng.com/thumbs/62c6f1487a58a4aa1fb770a7.png",
...
export default function DataTable() {
  ...
  return <DataTableComps columns={columns} data={data} getData={getData} />;
}
